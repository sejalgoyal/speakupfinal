...
public class groupadmin extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listv6);
        list1 = (ListView) findViewById(R.id.listv1);
        personList1 = new ArrayList<HashMap<String,String>>();

        getData();

        insert4 =(Button) findViewById(R.id.but6);
        insert4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Intent intent = new Intent(groupadmin.this, kk1.class);
    ...
    protected void showList(){
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(groupadmin.this, personList1, R.layout.list_item16,
                    new String[]{TAG_ID},
                    new int[]{R.id.id}
            );
    ...
    public void getData() {
        ...
        try
        {
            ...
            HttpPost httpPost=new HttpPost("http://seju.esy.es/admingrpname.php");
